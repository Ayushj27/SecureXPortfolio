      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          <div className="lg:col-span-5">
            ...
            <p className="text-foreground-muted text-lg max-w-sm mb-12 leading-relaxed">
              The AI platform for cyber risk management. Quantify, prioritize, and respond at the speed of risk.
            </p>
            <div className="flex gap-6">
              {['Twitter', 'LinkedIn'].map(social => (
                <span key={social} className="text-foreground-muted hover:text-foreground text-[10px] font-mono tracking-widest cursor-pointer transition-colors uppercase">
                  {social}
                </span>
              ))}
            </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12">
            <div>
              <h5 className="text-foreground font-semibold text-[10px] font-mono tracking-widest uppercase mb-8">Platform</h5>
            ...
            <div>
              <h5 className="text-foreground font-semibold text-[10px] font-mono tracking-widest uppercase mb-8">Resources</h5>
              <ul className="space-y-4 text-foreground-muted text-[10px] font-mono tracking-widest uppercase">
                <li><Link to="/resources" className="hover:text-accent transition-colors">Research</Link></li>
                <li><Link to="/case-studies" className="hover:text-accent transition-colors">Case Studies</Link></li>
                <li><Link to="/blog" className="hover:text-accent transition-colors">Blog</Link></li>
                <li><Link to="/resources" className="hover:text-accent transition-colors">Guides</Link></li>
              </ul>
            </div>
            <div>
              <h5 className="text-foreground font-semibold text-[10px] font-mono tracking-widest uppercase mb-8">Company</h5>
              <ul className="space-y-4 text-foreground-muted text-[10px] font-mono tracking-widest uppercase">
                ...
                <li><Link to="/company" className="hover:text-accent transition-colors">Legal</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-white/[0.06] flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-12 text-foreground-muted text-[10px] font-mono tracking-widest uppercase">
            <Link to="/privacy" className="hover:text-foreground transition-colors cursor-pointer">Privacy</Link>
            <Link to="/terms" className="hover:text-foreground transition-colors cursor-pointer">Terms</Link>
            <Link to="/cookies" className="hover:text-foreground transition-colors cursor-pointer">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
