...
const sourceCards = [
  {
    ...
    detail: 'Network, endpoint, SaaS, and GenAI pathways intercepted in real time.',
    icon: Globe,
    accent: 'text-cyan-200',
    border: 'border-cyan-300/18',
  },
  {
    title: 'Universal Actor Feed',
    detail: 'Identity telemetry, Active Directory mapping, bot registry, and malware tracking.',
    icon: Search,
    accent: 'text-sky-200',
    border: 'border-sky-300/18',
  },
  {
    title: 'Pre-Transmission Control',
    detail: 'Allowed vs. blocked events, classify-in-flight telemetry, and policy action reports.',
    icon: Target,
    accent: 'text-rose-200',
    border: 'border-rose-300/18',
  },
  {
    title: 'Sovereign Audit Records',
    detail: 'Local event store, compliance readiness files, and signed auditor-ready bundles.',
    icon: ShieldCheck,
...
const platformCapabilities = [
  {
    title: 'In-Flight Classification',
    detail: 'Performs real-time semantic analysis of moving data payload without templates.',
    icon: Radar,
    accent: 'text-cyan-200',
  },
  {
    title: 'Actor Identity Resolution',
    detail: 'Binds data movement events to specific humans, bots, AI agents, or malware.',
    icon: Database,
    accent: 'text-[#0030FF]/70',
  },
  {
    title: 'Zero-Touch Policy Enforcer',
    detail: 'Transforms AD structure into active rules, intercepting unauthorised transfers.',
    icon: Cpu,
    accent: 'text-[#0030FF]/70',
  },
  {
    title: 'Forensic GRC Mapping',
    detail: 'Binds intercept evidence directly to regulatory rules (DPDP, RBI, MeitY).',
    icon: Activity,
    accent: 'text-emerald-200',
  },
] as const;
...
const outcomeCards = [
  {
    ...
    detail: 'SOC teams get real-time block details, actor alerts, and immediate containment options.',
  },
  {
    title: 'Compliance & GRC',
    detail: 'Auditors receive continuous, non-repudiable readiness proof with signed artifacts.',
  },
  {
    title: 'Executive Leadership',
    detail: 'CISOs and CIOs see validated data risk scores, reduction metrics, and AI safety status.',
  },
] as const;
...
export default function DatraXHydraInfographic() {
  return (
    <div className="relative overflow-hidden rounded-[32px] border border-white/8 bg-[linear-gradient(180deg,rgba(13,18,30,0.98),rgba(8,11,18,0.98))] p-4 shadow-[0_28px_90px_rgba(0,0,0,0.34)] md:p-6 lg:p-8">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-foreground-muted lg:text-base">
          DatraX ingests data flow signals from across the environment, correlates them in one platform, and delivers prioritized outcomes for operations, leadership, and compliance.
        </p>
      </div>
      ...
      <div className="relative z-10 mx-auto mt-8 max-w-6xl md:mt-10">
        <div className="md:hidden space-y-4">
          ...
          <CardShell className="p-5 text-center">
            ...
            <div className="mt-3 text-[10px] font-mono uppercase tracking-[0.24em] text-cyan-200">DatraX Platform</div>
            ...
            <div className="mt-3 text-sm leading-relaxed text-foreground-muted">
              Discovery, actor identity resolution, auto classification, and compliance readiness operate in one shared control plane.
            </div>
          </CardShell>
        ...
        <div className="relative hidden md:block">
          ...
          <div className="mt-16 text-center text-[10px] font-mono uppercase tracking-[0.24em] text-cyan-200">DatraX Platform</div>
          <CardShell className="relative mt-4 p-6 lg:p-7">
            <div className="grid items-center gap-6 lg:grid-cols-[300px_minmax(0,1fr)]">
              <div className="rounded-[24px] border border-cyan-300/16 bg-[radial-gradient(circle_at_top,rgba(0,48,255,0.16),rgba(12,16,27,0.92))] p-6 text-center shadow-[0_0_60px_rgba(96,165,250,0.10)]">
                ...
                <div className="mt-4 text-[10px] font-mono uppercase tracking-[0.24em] text-cyan-200">DatraX Core</div>
                <div className="mt-2 text-2xl font-semibold tracking-tight text-foreground">Unified Correlation Plane</div>
                <div className="mt-3 text-sm leading-relaxed text-foreground-muted">
                  Connects data channels, actor identity, control evidence, and compliance context in one shared operating layer.
                </div>
              </div>
